 ...
 * License: MIT
 ...
 CHANGES:
  1- added minutes/hours verification on datetimepicker. search for AUTOCRUD
  2- typeahead opens on focus. search for ahneo. ref: http://stackoverflow.com/a/24817160/3381662
  3- clicking on the input field "minutes" or "hours" of time picker makes a selection of the whole box.
 */
  ...
  this.setupInputEvents = function(hoursInputEl, minutesInputEl) {
    ...
    hoursInputEl.bind('blur', function(e) {
      if (!$scope.invalidHours && $scope.hours < 10) {
        // AUTOCRUD - issue with datetimepicker plugin
...
angular.module("template/timepicker/timepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/timepicker/timepicker.html",
    ...
    "        <input style=\"width:50px;\" type=\"text\" onclick=\"$(this).select()\" ng-model=\"hours\" ng-change=\"updateHours()\" class=\"form-control text-center\" ng-readonly=\"::readonlyInput\" maxlength=\"2\">\n" + // AUTOCRUD AUTOSELECT TIMEPICKER
    "      </td>\n" +
    "      <td>:</td>\n" +
    "      <td class=\"form-group\" ng-class=\"{'has-error': invalidMinutes}\">\n" +
    "        <input style=\"width:50px;\" type=\"text\" onclick=\"$(this).select()\" ng-model=\"minutes\" ng-change=\"updateMinutes()\" class=\"form-control text-center\" ng-readonly=\"::readonlyInput\" maxlength=\"2\">\n" +  // AUTOCRUD AUTOSELECT TIMEPICKER
    "      </td>\n" +
